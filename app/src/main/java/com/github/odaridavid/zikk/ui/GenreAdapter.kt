 ...
 *
 **/
internal class GenreAdapter : ListAdapter<Genre, GenreAdapter.GenreViewHolder>(GenreDiffUtil) {
    ...
    override fun onBindViewHolder(holder: GenreViewHolder, position: Int): Unit =
